...
const Landingpage = () => {
    ...
    text-[0.8rem] md:top-[5rem] md:items-start md:text-left md:gap-[2.7rem] md:pr-[19rem] lg:pl-[2rem] lg:pr-[28rem] xl:pr-[30rem]">
                    ...
                    <div className="md:flex md:flex-col md:items-start md:text-left md:gap-[3rem] lg:gap-[2rem] text-[#FFFFFF]">
                        <div>
                            ...
                            <p className="sm:text-[1rem] md:text-[1.2rem] lg:text-[1.4rem]">Take off to new destinations with AeroLeon. Book
                        ...
                        <Link to="/FlightSearch">
                            <div className="gap-2 flex items-center justify-center text-center text-[1rem] pt-[18rem] md:pt-[0] sm:text-[1rem] md:text-[1.2rem] lg:text-[1.5rem]
                        cursor-pointer" id="adventure">
                                <p>Start My Adventure</p>
                                <FontAwesomeIcon icon={faArrowRight} className="sm:text-[1rem] md:text-[1.2rem] lg:text-[1.4rem]]" />
                            </div>
                        </Link>
                    </div>
                </div>
