...
const Landingpage = () => {
    ...
    text-[0.8rem] md:top-[5rem] md:items-start md:text-left md:gap-[2.7rem] md:pl-[2rem] md:pr-[22rem] lg:pl-[2rem] lg:pr-[29rem] xl:pr-[33rem]">
                    ...
                    <div className="md:flex md:flex-col md:items-start md:text-left md:gap-[3rem] lg:gap-[2rem] text-[#FFFFFF]">
                        <div>
                            <h1 className="pb-4 text-[1.6rem] sm:text-[1.8rem] md:text-[2.2rem] lg:text-[2.5rem]">Explore the World</h1>
